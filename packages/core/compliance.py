    ...
    def audit_legal_compliance(self, system_meta: Dict) -> Dict:
        ...
        audit_results = {
            ...
            "checks": [
                ...
                {"reg": "India DPDP", "requirement": "Data Fiduciary Appointment", "status": "PASS"},
        ...
        if not system_meta.get("human_oversight"):
            ...
            audit_results["legal_warnings"].append("Human-in-the-loop mechanism not detected (EU AI Act violation).")
